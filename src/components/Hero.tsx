...
export const Hero = () => {
  return <section id="home" className="min-h-screen hero-gradient relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 space-y-8">
            ...
            delay: 0.4
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-black tracking-tight uppercase">I'M RUDRO</h2>
            </motion.div>
            ...
            delay: 0.6
              ...
              <a href="#projects" className="inline-flex items-center justify-center px-8 py-4 bg-foreground text-background font-body font-semibold rounded-full hover:bg-foreground/90 transition-all duration-300">
                View Projects
              </a>
              <a href="#contact" className="inline-flex items-center justify-center px-8 py-4 border-2 border-foreground text-foreground font-body font-semibold rounded-full hover:bg-foreground hover:text-background transition-all duration-300">
                Get in Touch
              </a>
            </motion.div>
          </div>
          ...
          delay: 0.3
            ...
            <div className="relative">
              <div className="w-72 h-72 md:w-96 md:h-96 lg:w-[450px] lg:h-[450px] rounded-full overflow-hidden shadow-card bg-primary/20">
                <img alt="Shafaitul Kabir Rudro" className="w-full h-full object-cover object-top" src="/lovable-uploads/42e8d2f0-63f4-4b4f-872d-1fd0855e4fda.jpg" />
              </div>
